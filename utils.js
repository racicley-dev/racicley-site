...
const translations = {
    'pt': {
        ...
        about_desc: 'Atuo com desenvolvimento de software desde 2017 e, nos últimos 3 anos, tenho focado minha carreira na área de dados e Inteligência Artificial. Uno minha forte base em engenharia de software com o desenvolvimento e deploy de modelos preditivos, engenharia de dados e soluções de IA Generativa (GenAI). Tenho experiência prática na orquestração de agentes autônomos com LangGraph e AWS Bedrock Agents, além de aplicar boas práticas de MLOps em ambientes de nuvem (AWS e GCP).',
    ...
    'en': {
        ...
        about_desc: 'I have been working with software development since 2017 and, over the last 3 years, have focused my career on data and Artificial Intelligence. I combine my strong foundation in software engineering with the development and deployment of predictive models, data engineering, and Generative AI (GenAI) solutions. I have practical experience orchestrating autonomous agents with LangGraph and AWS Bedrock Agents, as well as applying MLOps best practices in cloud environments (AWS and GCP).',
